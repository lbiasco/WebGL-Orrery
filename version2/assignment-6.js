...
// Uniforms
var u_colorLoc; // Object color location
...
// Light attributes
var lightPosition = vec4(0.0, 0.707, 1.0, 0.0 ); // Light position (w-component: 0->vector, 1->point)
    // Lighting components (can set as vec4's to specify color, or generalize as scalars)
var lightAmbient = 0.0 // Ambient component
var lightDiffuse = 0.5 // Diffuse component
...
function setupSphere() {
    ...
    for (var latNumber=0; latNumber <= latitudeBands; latNumber++) {
        ...
        for (var longNumber=0; longNumber <= longitudeBands; longNumber++) {
            ...
            //sphereVertexNormalData.push(normalize(vec3(x, y, z)));
...
function drawBodies() {
    ...
    stack.push(ctm);
    drawSphere( vec4( 1.0, 1.0, 1.0, 1.0 ), size );
    stack.pop();
}
